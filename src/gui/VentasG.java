...
public class VentasG extends javax.swing.JFrame {
    ...
    public VentasG() {
        ...
        loadComEmp(jComboBox1);
        loadComPro(jComboBox2);
        VentasIn();
        resetear();
    }
    ...
    private void initComponents() {
        ...
        jButton12.setToolTipText("Ver productos de venta");
        ...
        jButton1.setToolTipText("Buscar ventas por fecha");
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        if (jTable3.getSelectedRow() != -1) {
            ...
            Ver.setTitle("The Groceries - Ver productos de venta");
    ...
    private void jComboBox2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox2ItemStateChanged
        if (jComboBox2.getSelectedIndex() != 0) {
            jTable1.setModel(productoDAO.cargarModeloP(jComboBox2.getSelectedIndex(), 0));
        } else {
            jTable1.setModel(productoDAO.cargarModeloA(1, 1));
        }
